...
import { kindLabel, kindOf } from '../three/mahjongTiles'
...
function syncFromState(st) {
  ...
  scene.setMyHand(st.my_hand || [], st.my_drawn ?? null, game.selected[0] ?? null)
  const rivers = [[], [], [], []]
  ...
  <div class="gamepage" v-if="room">
    ...
    <header class="hud top">
      ...
      <div class="right-c">
        ...
        <button v-if="phase === 'playing' || phase === 'dingque'" class="btn icon" :class="{ on: me?.auto }"
    ...
    <footer class="hud bottom">
      ...
      <div v-else-if="(phase === 'playing' || phase === 'dingque') && me?.auto" class="actions">
